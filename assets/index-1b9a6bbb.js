...
void main() {
	...
	void main() {
      ...
      `});this.object=new Zn(e,n),this.object.position.setZ(-2),this.updatePositionAndScale()}render(e){this.object.material.uniforms.uTime.value=e.clock.getElapsedTime(),this.updatePositionAndScale()}updatePositionAndScale(){this.object.geometry.dispose(),this.object.geometry=new jr(window.innerWidth,window.innerHeight)}}const An=new eD("#webgl",{enableOrbitControls:!1,renderer:{alpha:!0,antialias:!0,premultipliedAlpha:!1}});window.addEventListener("resize",t=>{const e=t.currentTarget.innerWidth,n=t.currentTarget.innerHeight;An.camera.aspect=e/n,An.camera.fov=Math.atan(n/2/An.camera.position.z)*2*(180/Math.PI),An.camera.updateProjectionMatrix(),An.renderer.setSize(e,n)});An.camera.position.z=600;An.camera.fov=Math.atan(window.innerHeight/2/An.camera.position.z)*2*(180/Math.PI);An.camera.updateProjectionMatrix();function vs(t){const e={appeared:{opacity:1,scale:1,filter:"blur(0px)"},dissapeared:{opacity:0,scale:.1,filter:"blur(50px)"}};return _e.jsx(Hr.button,{style:t.style,className:t.className,transition:{ease:[.72,.08,.31,.93],duration:1.5},variants:e,animate:t.inMainPage?"appeared":"dissapeared",onClick:t.onClick,children:t.children})}function oD(t){const e={appeared:{opacity:1,scale:1,filter:"blur(0px)"},dissapeared:{opacity:0,scale:.1,filter:"blur(50px)"}};return _e.jsxs(Hr.div,{style:{top:"30%",scale:.1,opacity:0},className:"page absolute md-w-60pc",transition:{ease:[.72,.08,.31,.93],duration:2.5},animate:t.isShown?"appeared":"dissapeared",variants:e,children:[_e.jsx("h2",{className:"block md-inline md-mr-l3",children:_e.jsxs("a",{target:"_blank",style:{fontSize:"inherit"},href:"https://github.com/andersonjoseph/shotbit",children:[_e.jsx("sup",{className:"mr-3",style:{fontSize:"0.5em"},children:"001"}),"shotbit"]})}),_e.jsx("h2",{className:"block md-inline md-mr-l3",children:_e.jsxs("a",{target:"_blank",style:{fontSize:"inherit"},href:"https://www.npmjs.com/package/fastify-hashids",children:[_e.jsx("sup",{className:"mr-3",style:{fontSize:"0.5em"},children:"002"}),"fastify-hashids"]})}),_e.jsx("br",{className:"hidden md-block"}),_e.jsx("h2",{className:"block md-inline md-mr-l3",children:_e.jsxs("a",{target:"_blank",style:{fontSize:"inherit"},href:"https://github.com/andersonjoseph/ossound",children:[_e.jsx("sup",{className:"mr-3",style:{fontSize:"0.5em"},children:"003"}),"ossound"]})}),_e.jsx("h2",{className:"block md-inline md-mr-l3 mt-l5 md-mt-0",children:_e.jsxs("a",{target:"_blank",style:{fontSize:"inherit"},href:"https://github.com/andersonjoseph",children:[_e.jsx("sup",{className:"mr-3",style:{fontSize:"0.5em"},children:"004"}),"more on github :)"]})})]})}function aD(t){const e={appeared:{opacity:1,scale:1,filter:"blur(0px)"},dissapeared:{opacity:0,scale:.1,filter:"blur(50px)"}};return _e.jsx(Hr.div,{style:{top:"30%",scale:.1,opacity:0},className:"page absolute md-w-60pc",transition:{ease:[.72,.08,.31,.93],duration:2.5},animate:t.isShown?"appeared":"dissapeared",variants:e,children:_e.jsxs("p",{children:["I'm a software developer with a passion for writing clean code.",_e.jsx("br",{}),"I contribute to open source projects and I love sharing my knowledge creating technical content."]})})}function lD(t){return _e.jsx("li",{style:{lineHeight:1},className:"list-none",children:_e.jsx("a",{href:t.href,target:"_blank",className:"inline article",children:t.children})})}function uD(t){return _e.jsx("ul",{children:t.children})}function cD(t){const[e,n]=Ae.useState([]);Ae.useEffect(()=>{async function r(){const o=await(await fetch("https://dev.to/api/articles?username=andersonjoseph")).json();n(o.slice(0,4))}r()},[]);const i={appeared:{opacity:1,scale:1,filter:"blur(0px)"},dissapeared:{opacity:0,scale:.1,filter:"blur(50px)"}};return _e.jsxs(Hr.div,{style:{top:"20%",scale:.1,opacity:0},className:"page absolute md-w-60pc",transition:{ease:[.72,.08,.31,.93],duration:2.5},animate:t.isShown?"appeared":"dissapeared",variants:i,children:[_e.jsx("p",{className:"article-label",children:"LATEST ARTICLES"}),_e.jsx(uD,{children:e.map((r,s)=>_e.jsx(lD,{href:r.url,children:r.title},`article-${s}`))}),_e.jsx("br",{}),_e.jsx("a",{style:{fontSize:"0.5em",fontWeight:"bold"},href:"https://dev.to/andersonjoseph",target:"_blank",className:"inline mt-5",children:"Read more here"})]})}function sf(t){const e={appeared:{opacity:1,scale:1,filter:"blur(0px)"},dissapeared:{opacity:0,scale:.1,filter:"blur(50px)"}};return _e.jsx(Hr.a,{className:t.className,href:t.href,style:t.style,target:"_blank",transition:{ease:[.72,.08,.31,.93],duration:1.5},variants:e,animate:t.inMainPage?"appeared":"dissapeared",children:t.children})}An.addObject(new sD);An.start();function fD(){const[t,e]=Ae.useState(!0),[n,i]=Ae.useState(!1),[r,s]=Ae.useState(!1),[o,a]=Ae.useState(!1),l={center:{y:"0vh"},up:{y:"-36vh"}},u={center:{y:"0vh"},down:{y:"42vh"}};function c(y){An.addObject(new rD(y.target))}function f(){e(!1),i(!0)}function d(){t||(e(!0),i(!1),s(!1),a(!1))}function p(){e(!1),s(!0)}function _(){e(!1),a(!0)}return _e.jsxs("main",{className:"h-100pc flex",children:[_e.jsx(oD,{isShown:n}),_e.jsx(aD,{isShown:r}),_e.jsx(cD,{isShown:o}),_e.jsx("div",{className:"hidden md-block w-20pc text-center self-center",children:_e.jsx(vs,{className:"self-center hidden md-inline-block",inMainPage:t,onClick:f,children:"projects"})}),_e.jsxs("div",{id:"logo",className:"m-5 md-m-0 md-w-60pc text-center flex flex-column justify-center h-100pc",children:[_e.jsx(vs,{className:"self-center hidden md-inline-block",inMainPage:t,onClick:p,style:{marginBottom:"3em"},children:"about me"}),_e.jsxs("div",{className:"flex flex-column justify-center",children:[_e.jsx(Hr.img,{transition:{duration:2,ease:[.72,.08,.31,.93],delay:.5},variants:l,animate:t?"center":"up",src:"./anderson.png",className:"self-center opacity-0 cursor-pointer",onLoad:c,onClick:d}),_e.jsx(Hr.img,{transition:{duration:2,ease:[.72,.08,.31,.93],delay:.5},variants:u,animate:t?"center":"down",src:"./joseph.png",className:"self-center opacity-0 cursor-pointer",onLoad:c,onClick:d})]}),_e.jsxs("ul",{className:"hidden md-flex justify-between",children:[_e.jsx("li",{className:"list-none",children:_e.jsx("a",{href:"mailto:andersonjoseph@mailfence.com",children:"andersonjoseph@mailfence.com"})}),_e.jsx("li",{className:"list-none",children:_e.jsx("a",{href:"https://twitter.com/ampersandjoseph",children:"twitter.com/ampersandjoseph"})}),_e.jsx("li",{className:"list-none",children:_e.jsx("a",{href:"https://github.com/andersonjoseph",children:"github.com/andersonjoseph"})})]}),_e.jsxs("div",{className:"flex md-hidden justify-between mt-l5",children:[_e.jsx(vs,{className:"self-center",inMainPage:t,onClick:f,children:"projects"}),_e.jsx(vs,{className:"self-center",inMainPage:t,onClick:p,children:"about me"}),_e.jsx(vs,{className:"self-center",inMainPage:t,onClick:_,children:"articles"})]}),_e.jsxs("div",{className:"flex md-hidden justify-around mt-l5",children:[_e.jsx(sf,{className:"w-10pc",href:"mailto:andersonjoseph@mailfence.com",inMainPage:t,children:_e.jsx("img",{src:"./email.svg"})}),_e.jsx(sf,{className:"w-10pc",href:"https://twitter.com/ampersandjoseph",inMainPage:t,children:_e.jsx("img",{src:"./twitter.svg"})}),_e.jsx(sf,{className:"w-10pc",href:"https://github.com/andersonjoseph",inMainPage:t,children:_e.jsx("img",{src:"./github.svg"})})]})]}),_e.jsx("div",{className:"hidden md-block w-20pc text-center self-center",children:_e.jsx(vs,{className:"self-center hidden md-inline-block",inMainPage:t,onClick:_,children:"articles"})})]})}of.createRoot(document.getElementById("root")).render(_e.jsx(wd.StrictMode,{children:_e.jsx(fD,{})}));
